...
@Component({
	...
	// this loads all angular2-google-maps directives in this component
	// the following line sets the height of the map - 
	// Important: if you don't set a height, you won't see a map!!
